...
void *
tiifhe_util_alloc(size_t len, size_t size)
{
	void *p;
...
uint64_t
tiifhe_util_bitrev(uint64_t a, size_t log2)
{
...
uint64_t
tiifhe_util_invmod(uint64_t a, uint64_t mod)
{
...
uint32_t
tiifhe_util_popcount32(uint32_t a)
{
...
uint64_t
tiifhe_util_rol64(uint64_t a, size_t r)
{
